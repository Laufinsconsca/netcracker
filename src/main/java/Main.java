...
public class Main {
    public static void main(String[] args) {
        ...
        Space office13 = new Office();
        Space office23 = new Office(90);
        Space office33 = new Office(60, 2);
        Floor officeFloor3 = new OfficeFloor(office13, office23, office33);
        ...
        Building officeBuilding = new OfficeBuilding(officeFloor1, officeFloor2, officeFloor3);
